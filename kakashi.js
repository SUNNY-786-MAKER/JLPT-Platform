...
class KakashiAssistant {
  ...
  generateResponse(userInput) {
    ...
    // 9. Default fallback (when no matches are found in databases or comparisons)
    return {
      text: `Interesting question! I couldn't find a direct match for "${searchPhrase || userInput}" in my active local JLPT database, but as your tutor Kakashi, here is my general advice:\n\n* **Verb & Particle Focus:** In Japanese, focus heavily on the grammatical particles (like \`は\`, \`が\`, \`に\`, \`で\`, \`ので\`, \`から\`) as they define the relations in a sentence.\n* **Writing Correction:** You can test your sentences by typing **"correct: [your Japanese sentence]"**.\n* **Sentence Analysis:** Type **"breakdown: [your Japanese sentence]"** and I will dissect the structure for you.\n\nCould you rephrase your question or ask about a specific JLPT N5-N3 vocab word, kanji character, or grammar pattern? I'm ready!`
    };
  }
